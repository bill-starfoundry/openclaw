...
describe("npm extended-stable closeout workflow", () => {
  ...
  it("regenerates all-publishable inventory and uploads the exact compact artifact contract", () => {
    expect(step("Generate canonical all-publishable plugin plan").run).toContain(
